...
cosine_df_rounded = pd.DataFrame(cosine_matrix_rounded, index=d[0], columns=d[0]).round(4)
# print(jaccard_df)

# Send to CSV
cosine_df.to_csv(RESULTS + "pmid_cosine_matrix.csv", mode="w")
cosine_df_rounded.to_csv(RESULTS + "pmid_cosine_matrix_rounded.csv", mode="w")
...
plt.title("Cosine GO PMID Heatmap")
fig.savefig(FIGURES + "cosine_go_pmid_heatmap.png", dpi=1200, bbox_inches="tight")
